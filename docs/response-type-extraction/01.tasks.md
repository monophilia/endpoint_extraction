...
| # | タスク | Phase | 状態 | 進行形 |
|---|--------|-------|------|--------|
| 1 | ResponseInfo型を定義する | 1 | pending | ResponseInfo型を定義している |
| 2 | ErrorResponseInfo型を定義する | 1 | pending | ErrorResponseInfo型を定義している |
| 3 | EndpointInfo型にresponsesを追加する | 1 | pending | EndpointInfo型を拡張している |
| 4 | ExtractorOptions型を拡張する | 1 | pending | ExtractorOptions型を拡張している |
| 5 | YAML出力型を拡張する | 1 | pending | YAML出力型を拡張している |
| 6 | ResponseExtractor用テストを作成する（Phase 1） | 1 | pending | ResponseExtractorテストを作成している |
| 7 | ResponseExtractorを実装する（Phase 1） | 1 | pending | ResponseExtractorを実装している |
| 8 | RouteFileParserにResponseExtractorを統合する | 1 | pending | ResponseExtractorを統合している |
| 9 | YamlGeneratorにレスポンス出力を追加する | 1 | pending | レスポンス出力を追加している |
| 10 | CLIに--extract-responsesオプションを追加する | 1 | pending | CLIオプションを追加している |
