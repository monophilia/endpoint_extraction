...
- **Phase 2**: 完了 (タスク11-13 全てcompleted)
- **Phase 3**: 完了 (タスク14-16 全てcompleted)
...
| 11 | 変数追跡用テストを作成する | 2 | completed | 変数追跡テストを作成している |
| 12 | resolveVariableValueを実装する | 2 | completed | 変数値解決を実装している |
| 13 | resolveVariableTypeを実装する | 2 | completed | 変数型解決を実装している |
| 14 | 高度な解析用テストを作成する | 3 | completed | 高度な解析テストを作成している |
| 15 | analyzeExternalFunctionを実装する | 3 | completed | 外部関数解析を実装している |
| 16 | CLIに--deep-analysisオプションを追加する | 3 | completed | --deep-analysisを追加している |
